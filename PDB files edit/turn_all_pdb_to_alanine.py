# -*- coding: utf-8 -*-
"""
Created on Tue Nov 21 14:11:51 2023

@author: danist
"""
from biopandas.pdb import PandasPdb

def convert_to_polyalanine(input_pdb_file, output_pdb_file):
...
output_file_name= 'Bfr12_polyala_test.pdb'# Change this to the desired output PDB file name
...
if __name__ == "__main__":
    ...
    convert_to_polyalanine(input_pdb_file, output_pdb_file)
